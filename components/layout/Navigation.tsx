...
const navLinks = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Title Fees', href: '/homebuyers/title-fees' },
      { label: 'Title Insurance Premiums', href: '/homebuyers/title-insurance' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'What is Title Insurance?', href: '/homebuyers/title-insurance' },
      { label: "Owner's Title Insurance", href: '/homebuyers/owners-title-insurance' },
      { label: 'FIRPTA', href: '/resources/firpta' },
      { label: 'Pre-Closing Guide', href: '/homebuying' },
      { label: 'Post-Closing Guide', href: '/resources/post-closing-guide' },
      { label: 'DC Tax Abatement', href: '/resources/dc-tax-abatement' },
      { label: 'Homestead Deduction', href: '/resources/homestead-deduction' },
      { label: 'Reduced Recordation', href: '/resources/reduced-recordation' },
      { label: 'First-Time Homebuyer', href: '/resources/first-time-homebuyer' },
    ],
  },
  {
    label: 'Contact',
