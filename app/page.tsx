...
const testimonials = [
  {
    quote: 'Super quick replies and very helpful staff, including really detailed explanations for each step. Everything went smoothly!',
  ...
  {
    quote: 'They were consistently very personal, helpful and polite. Our experience during closing was remarkable. Both were very patient and explained all documents very carefully.',
    author: 'DC Homebuyer',
    role: 'Website',
    rating: 5,
    source: 'Website',
  ...
  {
    quote: 'Federal Title is a well-oiled machine and makes that big financial decision so much easier.',
  ...
  {
    quote: 'They were on it immediately. I had questions at 8pm and got a response within the hour. That kind of responsiveness is rare and made all the difference when we were stressed about our closing timeline.',
    author: 'DC Seller',
    role: 'Google',
    rating: 5,
    source: 'Google',
  ...
  {
    quote: 'I had an excellent experience with Federal Title. From the initial quote through the closing day, every detail was handled professionally.',
  ...
  {
    quote: 'Federal Title saved us over $1,400 compared to what our agent\'s recommended title company quoted. And the service was better.',
