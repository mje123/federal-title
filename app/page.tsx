...
const features = [
  {
    ...
    link: { text: 'Learn More', href: '/deposit-earnest-money' },
  },
  {
...
const comparisonData = [
  {
    ...
    averagePrice: '$677,000',
    competitorCost: '$6,950',
    federalTitleCost: '$5,150',
    savings: '$1,800',
  },
  {
    jurisdiction: 'Maryland',
    averagePrice: '$450,000',
    competitorCost: '$5,250',
    federalTitleCost: '$3,850',
    savings: '$1,400',
  },
  {
    jurisdiction: 'Virginia',
    averagePrice: '$485,000',
    competitorCost: '$4,950',
    federalTitleCost: '$3,950',
    savings: '$1,000',
  },
];
          ...
          <div className="container mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
              {googleReviews.map((review, i) => (
                <a key={i} href={review.googleMapsUri ?? review.authorAttribution.uri ?? '#'} target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-[var(--color-neutral-200)] p-7 flex flex-col hover:border-[var(--color-accent-300)] hover:shadow-md transition-all">
