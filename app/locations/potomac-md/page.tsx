...
export const metadata: Metadata = {
  title: 'Potomac, MD Office | Federal Title & Escrow Company',
  description: 'Federal Title\'s Potomac, Maryland office at 10000 Falls Road, Suite 101, Potomac, MD 20854.',
};
    ...
    <>
      <section className="bg-[var(--color-primary-900)] text-white py-20">
        <div className="container mx-auto px-6">
          <p className="text-[var(--color-accent-400)] font-semibold text-sm uppercase tracking-widest mb-3">Potomac · Est. 2021</p>
          <h1 className="text-5xl lg:text-6xl font-bold mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>Potomac, MD</h1>
          <p className="text-xl text-white/70 max-w-xl">Federal Title&apos;s Potomac, Maryland office serving Montgomery County&apos;s western communities.</p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl border border-[var(--color-neutral-200)] p-8">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-3"><MapPin className="h-5 w-5 text-[var(--color-primary-600)] mt-0.5 shrink-0" /><div><p className="font-medium text-[var(--color-neutral-900)]">Address</p><p className="text-[var(--color-neutral-600)]">10000 Falls Road, Suite 101 (Use Elevator)</p><p className="text-[var(--color-neutral-600)]">Potomac, MD 20854</p></div></div>
