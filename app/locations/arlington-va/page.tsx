...
export const metadata: Metadata = {
  title: 'Clarendon / Arlington, VA Office | Federal Title & Escrow Company',
  description: 'Federal Title\'s Arlington, Virginia office at 3101 Wilson Boulevard, Suite 500, Arlington, VA 22201. Attorney-led title company in Clarendon.',
};
    ...
    <>
      <section className="bg-[var(--color-primary-900)] text-white py-20">
        <div className="container mx-auto px-6">
          <p className="text-[var(--color-accent-400)] font-semibold text-sm uppercase tracking-widest mb-3">Arlington · Est. 2021</p>
          <h1 className="text-5xl lg:text-6xl font-bold mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>Clarendon / Arlington</h1>
          <p className="text-xl text-white/70 max-w-xl">Federal Title&apos;s Arlington, Virginia office serving Northern Virginia.</p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="space-y-6">
              <div className="bg-white rounded-xl border border-[var(--color-neutral-200)] p-8">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-3"><MapPin className="h-5 w-5 text-[var(--color-primary-600)] mt-0.5 shrink-0" /><div><p className="font-medium text-[var(--color-neutral-900)]">Address</p><p className="text-[var(--color-neutral-600)]">3101 Wilson Boulevard, Suite 500</p><p className="text-[var(--color-neutral-600)]">Arlington, VA 22201</p></div></div>
            ...
            <div className="rounded-xl overflow-hidden border border-[var(--color-neutral-200)] h-[480px] lg:h-auto">
              <iframe
                ...
                title="Clarendon / Arlington Office Map"
              />
            </div>
          </div>
        </div>
