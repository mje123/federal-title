...
export const metadata: Metadata = {
  title: 'Fairfax, VA Office | Federal Title & Escrow Company',
  description: 'Federal Title\'s newest office in Fairfax, Virginia — 3975 Fair Ridge Drive, Suite T25S-A, Fairfax, VA 22033. Opening 2026.',
};
    ...
    <>
      <section className="bg-[var(--color-primary-900)] text-white py-20">
        <div className="container mx-auto px-6">
          <p className="text-[var(--color-accent-400)] font-semibold text-sm uppercase tracking-widest mb-3">Fairfax · Est. 2026 · New!</p>
          <h1 className="text-5xl lg:text-6xl font-bold mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>Fairfax, VA</h1>
          <p className="text-xl text-white/70 max-w-xl">Federal Title&apos;s newest office in Fairfax, Virginia — opening 2026 to better serve Northern Virginia clients.</p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl border border-[var(--color-neutral-200)] p-8">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-3"><MapPin className="h-5 w-5 text-[var(--color-primary-600)] mt-0.5 shrink-0" /><div><p className="font-medium text-[var(--color-neutral-900)]">Address</p><p className="text-[var(--color-neutral-600)]">3975 Fair Ridge Drive, Suite T25S-A</p><p className="text-xs text-[var(--color-neutral-400)]">South Building Ground Floor — Level T</p><p className="text-[var(--color-neutral-600)]">Fairfax, VA 22033</p></div></div>
